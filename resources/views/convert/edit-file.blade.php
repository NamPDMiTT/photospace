        ...
        <div class="flex justify-between">
            <div class="flex gap-2">
                <label for="choose-file"
                    class="flex gap-1 py-2 px-3 bg-purple-200 border-2 border-purple-400 rounded-lg rounded-b-none border-b-0 hover:bg-purple-300 cursor-pointer">
                    ...
                    <input type="file" name="" id="choose-file" class="hidden">
                </label>
            ...
            <div class="flex gap-2">
                ...
                <button
                    ...
                    <span class="text-lg font-medium text-white">Convert All</span>
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 text-white dark:text-white" viewBox="0 0 23 25"
                        fill="none">
                        <path d="M4.6001 5.66467L11.7876 13.1764L4.6001 20.6882" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
                </button>
            </div>
            ...
            <div class="flex justify-between">
                <div class="flex gap-4 items-center">
                    ...
                    <div class="">
                        ...
                        <div class="flex gap-2">
                            <p class="text-[#209A3B]">Ready to convert</p>
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 m-auto" viewBox="0 0 22 20"
                                fill="none">
                                <path
                                    ...
                                    stroke="#209A3B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex justify-between">
                <div class="flex gap-4 items-center">
                    ...
                    <div class="">
                        ...
                        <div class="flex gap-2">
                            <p class="text-[#F83F31]">Fail to load</p>
